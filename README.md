...
<picture>
  <source media="(prefers-color-scheme: dark)"
          srcset="https://github.com/user-attachments/assets/70be2055-1800-41e3-9280-abd962a36667">
  <img src="https://github.com/user-attachments/assets/05ae7e96-177d-4331-a815-53a53ee720f6"
       height="200" alt="Casanchess Logo">
</picture>
...
* ***Incremental progress:*** Improvements are made iteratively using strict SPRT testing. Development takes time since the hardware for testing is limited! But the focus remains on organic growth.
...
* **``Ambition``**: Modifies the score to favor positions less likely to draw, estimated from a dedicated NNUE output head.
The value is the maximum score adjustment in centipawns; 0 disables the feature and is slightly faster. Default: 15.
...
Feel free to open an issue or contact me at casanchess.engine@gmail.com.

## Special thanks
The engine has evolved significantly since its early beginnings around 2018.
Projects like [Winglet](https://web.archive.org/web/20120621100214/http://www.sluijten.com/winglet/) and [ShallowBlue](https://github.com/GunshipPenguin/shallow-blue) introduced me to bitboards and the very first chess-programming concepts to get started, while [cerebrum](https://github.com/david-carteau/cerebrum) helped me get started with its simple NNUE implementation.

Big thanks to the always amazing chess programming community.
The knowledge openly shared on the [Talkchess.com](http://talkchess.com) forums and the [Chess Programming Wiki](https://www.chessprogramming.org) has been an essential resource throughout this journey.
And special mention to the testers, who contributed games, reports and feedback that helped improve the engine.
